...
[M] Given the head of a Singly LinkedList, write a method to modify the LinkedList 
...
Your algorithm should not use any extra 
space and the input LinkedList should be modified in-place.
