...
[H] Given a string and a list of words, find all the starting indices of substrings 
in the given string that are a concatenation of all the given words exactly once without 
...
# Time: O(n * m * len(word)) Space: O(m + n) -> two hashMap
